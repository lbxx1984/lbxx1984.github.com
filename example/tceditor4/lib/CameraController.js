(function($) {
	...
	$.fn.CameraController = function(param) {
		...
		var info = [
			{tid:"font",x:20,y:0,z:0,rx:0,ry:0.5,rz:0,a:30,b:30},
			{tid:"back",x:-20,y:0,z:0,rx:0,ry:-0.5,rz:0,a:30,b:30},
			{tid:"top",x:0,y:20,z:0,rx:-0.5,ry:0,rz:0,a:30,b:30},
			{tid:"bottom",x:0,y:-20,z:0,rx:0.5,ry:0,rz:0,a:30,b:30},
			{tid:"left",x:0,y:0,z:20,rx:0,ry:0,rz:0,a:30,b:30},
			{tid:"right",x:0,y:0,z:-20,rx:0,ry:-1,rz:0,a:30,b:30},
			{tid:"font_left_top",x:17.5,y:17.5,z:17.5,rx:0,ry:0,rz:0,a:5,b:5,c:5},
			{tid:"font_right_top",x:17.5,y:17.5,z:-17.5,rx:0,ry:0,rz:0,a:5,b:5,c:5},
			{tid:"left_top_back",x:-17.5,y:17.5,z:17.5,rx:0,ry:0,rz:0,a:5,b:5,c:5},
			{tid:"back_top_right",x:-17.5,y:17.5,z:-17.5,rx:0,ry:0,rz:0,a:5,b:5,c:5},
			{tid:"left_font_bottom",x:17.5,y:-17.5,z:17.5,rx:0,ry:0,rz:0,a:5,b:5,c:5},
			{tid:"font_right_bottom",x:17.5,y:-17.5,z:-17.5,rx:0,ry:0,rz:0,a:5,b:5,c:5},
			{tid:"left_back_bottom",x:-17.5,y:-17.5,z:17.5,rx:0,ry:0,rz:0,a:5,b:5,c:5},
			{tid:"right_back_bottom",x:-17.5,y:-17.5,z:-17.5,rx:0,ry:0,rz:0,a:5,b:5,c:5},
			{tid:"left_top",x:0,y:17.5,z:17.5,rx:0,ry:0,rz:0,a:30,b:5,c:5},
			{tid:"left_bottom",x:0,y:-17.5,z:17.5,rx:0,ry:0,rz:0,a:30,b:5,c:5},
			{tid:"top_right",x:0,y:17.5,z:-17.5,rx:0,ry:0,rz:0,a:30,b:5,c:5},
			{tid:"bottom_right",x:0,y:-17.5,z:-17.5,rx:0,ry:0,rz:0,a:30,b:5,c:5},
			{tid:"top_font",x:17.5,y:17.5,z:0,rx:0,ry:0,rz:0,a:5,b:5,c:30},
			{tid:"bottom_font",x:17.5,y:-17.5,z:0,rx:0,ry:0,rz:0,a:5,b:5,c:30},
			{tid:"back_bottom",x:-17.5,y:-17.5,z:0,rx:0,ry:0,rz:0,a:5,b:5,c:30},
			{tid:"top_back",x:-17.5,y:17.5,z:0,rx:0,ry:0,rz:0,a:5,b:5,c:30},
			{tid:"font_left",x:17.5,y:0,z:17.5,rx:0,ry:0,rz:0,a:5,b:30,c:5},
			{tid:"font_right",x:17.5,y:0,z:-17.5,rx:0,ry:0,rz:0,a:5,b:30,c:5},
			{tid:"back_right",x:-17.5,y:0,z:-17.5,rx:0,ry:0,rz:0,a:5,b:30,c:5},
			{tid:"back_left",x:-17.5,y:0,z:17.5,rx:0,ry:0,rz:0,a:5,b:30,c:5}
		];
				...
				mesh = new THREE.Mesh(
					...
					new THREE.MeshBasicMaterial({
						map: THREE.ImageUtils.loadTexture(
							"textures/" + info[n].tid + "_" + param.language + ".png"
						)
					})
				);
			} else if (n > 5) {
		...
		_this
			.bind("mouseleave", function() {
				if (_INTERSECTED) {
					_INTERSECTED.material.opacity = 1;
				}
				_INTERSECTED = null;
			})
		...
		function toA(dx) {
			...
			if (_cameraAngleA < 90 && _cameraAngleA + dy > 90) {
				dy = 0
			}
			if (_cameraAngleA > -90 && _cameraAngleA + dy < -90) {
				dy = 0
